...
})({"1PLhU":[function(require,module,exports) {
...
if (ip) renderLocation("ipAddress", ip);
...
form.addEventListener("submit", (e)=>{
    ...
    if (/\d+\.\d+/.test(input)) renderLocation("ipAddress", input);
    else renderLocation("domain", input);
});
// Display Map
